...
#jm-wrapper{
	background:url("images/default/bg-jm-wrapper-hallowen.png") no-repeat center bottom;
}
...
#jm-bots2{
	background:<?php echo $baseconfig["bots2color"] ?> url("images/<?php echo $baseconfig["bots2bg"]; ?>") no-repeat top center;
}
...
button.button.blue.btn-wishlist span, 
button.button.blue.btn-compare span{
...
.jm-tabs .head{
	background-image: url("images/default/bg-title.png");
	border: 0px none;
	min-height: 65px;
}
...
#jm-mass-bottom .block-title{
	background-image: url("images/default/bg-title-block.png");
	border: none;
}

#jm-mass-bottom .block-pre-order.green .block-title{
	background-image: url("images/default/bg-title-block-pre-order.png");
	text-shadow: 0 0 10px #C86372;
	filter:	
	progid:DXImageTransform.Microsoft.Shadow(color=#f26432,direction=0,strength=2);
}

body:last-child #jm-mass-bottom .block-pre-order.green .block-title{
	filter:	none;
}

#jm-mass-bottom .block-most-anticipated.blue .block-title{
	background-image: url("images/default/bg-title-block-most-anticipated.png");
	border: 1px solid #222;
}

#jm-mass-bottom .block-good-prices .block-content{
	background: #fff url("images/default/bg-block-content-good-prices.jpg") no-repeat left bottom;
}
...
.footer-socials li.facebook{
	background-image: url("images/default/ico-facebook.png");
}

.footer-socials li.twitter{
	background-image: url("images/default/ico-twitter.png");
}

.footer-socials li.fgoogle-plus{
	background-image: url("images/default/ico-googleplus.png");
}

.footer-socials li.youtube{
	background-image: url("images/default/ico-youtube.png");
}

.footer-socials li.instagram{
	background-image: url("images/default/ico-instagram.png");
}

#jm-bots2 .block-get-connected{
	position: relative;
}

#jm-bots2 .block-get-connected .block-title{
	margin: 0px;
	position: absolute;
    top: 0;
    width: 100%;
...
#jm-bots2 .block-get-connected .block-content{
	overflow: hidden;
    padding-top: 28px;
}